...
("Modelagem 3D","Modelagem 3D de Personagens", "pretinho.linkedin", "pretinho.instagram", "pretinho", "310", "https@@######@", 20),
("IA", "Introdução À inteligencia artificial","Nerevaldo.linkedin", "Nerevaldo.instagram", "Nerevaldo", "306", "https@@######@", 20),
("C#", "Programação em C#", "Faz o L", "22 é bozo", "bozo", "307", "https@@######@", 20);
